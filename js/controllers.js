...
buyndsControllers.controller('MultiKeyGenCtrl', ['$scope', '$modal', '$route', '$window', 'bindBuilder', 'bindLoaderAsync', 'bindRepository', 'dataService', function ($scope, $modal, $route, $window, bindBuilder, bindLoaderAsync, bindRepository, dataService) {
